# Memory Negative-Transfer Case Study: folded_cascode-v1 -> ldo-v1

folded_cascode-v1 -> ldo-v1 shows governed cross-family reuse holding harmful transfer at 0.000, while no-governance rises to 1.000 and forced transfer rises to 1.000.
