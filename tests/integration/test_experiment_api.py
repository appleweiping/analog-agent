    ...
    def test_run_suite_compares_three_modes(self) -> None:
        ...
        response = client.post(
            ...
            json={
                ...
                "modes": ["full_simulation_baseline", "random_search_baseline", "bayesopt_baseline", "cmaes_baseline", "rl_baseline", "no_world_model_baseline", "full_system"],
        ...
        self.assertIn("rl_baseline", summaries)
