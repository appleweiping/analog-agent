...
class BenchmarkRegistryTests(unittest.TestCase):
    ...
    def test_all_benchmark_definitions_validate(self) -> None:
        ...
        self.assertEqual(
            ...
            ["frozen_runnable", "frozen_runnable", "frozen_runnable", "frozen_runnable"],
        )

    def test_all_four_vertical_slices_are_current_runnable_benchmarks(self) -> None:
        ...
        self.assertEqual(bandgap.execution_readiness, "frozen_runnable")
        self.assertTrue(bandgap.vertical_slice_bound)
        self.assertEqual(runnable_benchmark_ids(), ["ota2_v1", "folded_cascode_v1", "ldo_v1", "bandgap_v1"])
    ...
    def test_cross_family_metric_contracts_are_explicit(self) -> None:
        ...
        self.assertIn("temperature_coefficient_ppm_per_c", bandgap.measurement_contract.primary_metrics)
        self.assertIn("line_regulation_mv_per_v", bandgap.measurement_contract.primary_metrics)
