...
def main() -> None:
    ...
    repeated_bundles = [
        build_memory_ablation_evidence_bundle(
            run_ota_memory_ablation_suite(episodes=args.episodes, max_steps=args.steps),
            figures_dir=args.output_root / "ota2_repeated_figs",
            tables_dir=args.output_root / "ota2_repeated_tables",
            json_output_path=args.output_root / "ota2_repeated_memory_bundle.json",
        ),
        build_memory_ablation_evidence_bundle(
            run_folded_cascode_memory_ablation_suite(episodes=args.episodes, max_steps=args.steps),
            figures_dir=args.output_root / "folded_repeated_figs",
            tables_dir=args.output_root / "folded_repeated_tables",
            json_output_path=args.output_root / "folded_repeated_memory_bundle.json",
        ),
        build_memory_ablation_evidence_bundle(
            run_ldo_memory_ablation_suite(episodes=args.episodes, max_steps=args.steps),
            figures_dir=args.output_root / "ldo_repeated_figs",
            tables_dir=args.output_root / "ldo_repeated_tables",
            json_output_path=args.output_root / "ldo_repeated_memory_bundle.json",
        ),
        build_memory_ablation_evidence_bundle(
            run_bandgap_memory_ablation_suite(episodes=args.episodes, max_steps=args.steps),
            figures_dir=args.output_root / "bandgap_repeated_figs",
            tables_dir=args.output_root / "bandgap_repeated_tables",
            json_output_path=args.output_root / "bandgap_repeated_memory_bundle.json",
        ),
    ]
    ...
    folded_to_ldo = run_memory_transfer_evidence(
        ...
        output_root=args.output_root / "folded_cascode_to_ldo",
    )
    folded_to_bandgap = run_memory_transfer_evidence(
        ...
        output_root=args.output_root / "folded_cascode_to_bandgap",
    )
