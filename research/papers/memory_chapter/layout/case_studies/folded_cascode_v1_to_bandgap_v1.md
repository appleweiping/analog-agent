# Memory Negative-Transfer Case Study: folded_cascode-v1 -> bandgap-v1

folded_cascode-v1 -> bandgap-v1 shows governed cross-family reuse holding harmful transfer at 0.000, while no-governance rises to 0.500 and forced transfer rises to 0.500.

## Structured Metrics

- Governed harmful-transfer rate: `0.0`
- No-governance harmful-transfer rate: `0.5`
- Forced-transfer harmful-transfer rate: `0.5`
