...
def _load_ldo_as_benchmark_task() -> BenchmarkTaskDefinition:
    ...
    return BenchmarkTaskDefinition(
        ...
        notes=[
            "first_regulator_family_generalization_task",
            "ldo_v1_is_now_runnable",
            "shares_agentic_contract_with_ota_v1_and_folded_cascode_v1",
        ],
    )
