"""Run the frozen OTA v1 experiment suite and export benchmark stats."""
...
def main() -> None:
    ...
    parser.add_argument("--output", default="archive/research/benchmarks/ota2_experiment_results.json")
