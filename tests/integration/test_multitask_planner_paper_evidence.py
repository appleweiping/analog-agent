...
class MultiTaskPlannerEvidenceTests(unittest.TestCase):
    def _assert_bundle_outputs(self, root: Path, bundle) -> None:
        ...
        self.assertTrue((root / "planner_figs" / "planner_topk_efficiency.svg").exists())
        self.assertTrue((root / "planner_figs" / "planner_fidelity_tradeoff.svg").exists())
        self.assertTrue((root / "planner_figs" / "planner_phase_convergence.svg").exists())
        self.assertTrue((root / "planner_figs" / "planner_calibration_utility.svg").exists())
        self.assertTrue((root / "planner_figs" / "planner_rollout_claim_audit.svg").exists())
        self.assertTrue((root / "planner_figs" / "planner_failure_pressure.svg").exists())
        self.assertTrue((root / "planner_figs" / "planner_efficiency_frontier.svg").exists())
        ...
        self.assertTrue((root / "planner_tables" / "planner_topk_utility.csv").exists())
        self.assertTrue((root / "planner_tables" / "planner_fidelity_tradeoff.csv").exists())
        self.assertTrue((root / "planner_tables" / "planner_phase_utility.csv").exists())
        self.assertTrue((root / "planner_tables" / "planner_calibration_utility.csv").exists())
        self.assertTrue((root / "planner_tables" / "planner_rollout_claim_audit.csv").exists())
        self.assertTrue((root / "planner_tables" / "planner_failure_mode_summary.csv").exists())
        self.assertTrue((root / "planner_tables" / "planner_efficiency_synthesis.csv").exists())
